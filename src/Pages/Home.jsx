      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav ms-auto text-lg gap-lg-0 gap-2">
            ...
            <li className="nav-item my-auto">
              <div className="nav-link" href="#">Games</div>
            </li>
            <li className="nav-item my-auto">
              <div className="nav-link" href="#">Rewards</div>
            </li>
            <li className="nav-item my-auto">
              <div className="nav-link" href="#">Discover</div>
            </li>
            <li className="nav-item my-auto me-lg-20">
              <div className="nav-link" href="#">Global Rank</div>
            </li>
            <li className="nav-item my-auto">
              <div className="btn btn-sign-in d-flex justify-content-center ms-lg-2 rounded-pill" href="./src/sign-in.html" role="button">Sign
                In</div>
            </li>
          </ul>
        </div>
      ...
      <div className="row gap-lg-0 gap-5">
        <div className="col-lg-6 col-12 my-auto">
          ...
          <div className="d-flex flex-lg-row flex-column gap-4">
            <div className="btn btn-get text-lg text-white rounded-pill" href="#feature" role="button">Get
              Started</div>
            <div className="btn-learn text-lg color-palette-1 my-auto text-center" href="#" role="button">Learn
              More</div>
          </div>
        </div>
        ...
        <div className="col-lg-5 col-12 ps-lg-60">
          <div className>
            ...
            <div className="d-md-block d-flex flex-column w-100">
              <div className="btn btn-read text-lg rounded-pill" href="#" role="button">Read Story</div>
            </div>
          </div>
        </div>
      </div>
